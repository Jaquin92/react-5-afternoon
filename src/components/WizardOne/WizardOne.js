...
import { updateProp, updateLoanType } from "../../ducks/reducer";
    ...
    return (
      <div className="parent-div">
        <div className="vert-align">
          ...
          <select onChange={e => this.props.updateProp(e.target.value)}>
...
export default connect(mapStateToProps, { updateLoanType, updateProp })(
  WizardOne
);
